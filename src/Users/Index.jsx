    ...
    this.users_columns = [
      {
        ...
        Cell: ({ row }) => (
          <Fragment>
            <Profile
              url={row['_original'].profileImage}
                ...
                content={
                  <Fragment>
                    ...
                    <AddUpdateUser
                      ...
                      city={city}
                      userTypeId={userTypeId}
                      countryList={country_list_array}
                      stateList={state_list_array}
                      userTypesList={userTypesList}
                      addUpdateUserDetails={this.addUpdateUserDetails}
                    />
                    {/* User Modal */}
                  </Fragment>
                }
